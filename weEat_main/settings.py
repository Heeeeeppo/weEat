"""
Django settings for weEat_main project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'weeat.herokuapp.com']
...
WSGI_APPLICATION = 'weEat_main.wsgi.application'
...
ALLOWED_HOSTS=['weeat.herokuapp.com']       #wangcccomments是之前新建的应用名